    ...
    return (
        <>
            ...
            <Head>
                ...
                <meta property="og:title" content={`${capitalizeFirstLetter(creatorData.creatorName.replace('+', " ").replace("+", " "))} Porn Videos - Chutlunds`} />
                ...
                <meta name="twitter:title" content={`${capitalizeFirstLetter(creatorData.creatorName.replace('+', " ").replace("+", " "))} Porn Videos - Chutlunds`} />
                ...
                <link rel="canonical" href={`https://www.chutlunds.com/channels/${creatorName}/${creatorCode}`} />
