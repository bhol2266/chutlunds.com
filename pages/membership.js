...
const Membership = () => {
    ...
    const getAccessNowOnClick = () => {
        ...
        router.push(`https://www.ukdevelopers.org/membership?planAmount=${selectedPlan.amount}&planDuration=${selectedPlan.duration}&planCode=${selectedPlan.planCode}&source=${"Chutlunds"}`);
