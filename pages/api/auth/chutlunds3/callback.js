...
export default async function handler(req, res) {
  ...
  const redirectUri = "https://www.chutlunds3.com/api/auth/chutlunds3/callback"; // Make sure this matches your registered URI
  ...
  try {
    ...
    await fetch(`http://www.chutlunds3.com/api/auth/saveProfileFirestore`, {
      method: 'POST',
      headers: {
