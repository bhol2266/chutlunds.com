...
export default async function handler(req, res) {
  ...
  const redirectUri = "https://www.chutlunds4.com/api/auth/chutlunds4/callback"; // Make sure this matches your registered URI
  ...
  try {
    ...
    await fetch(`http://www.chutlunds4.com/api/auth/saveProfileFirestore`, {
      method: 'POST',
      headers: {
