...
export default async function handler(req, res) {
  ...
  const redirectUri = "https://www.chutlunds2.com/api/auth/chutlunds2/callback"; // Make sure this matches your registered URI
  ...
  try {
    ...
    await fetch(`http://www.chutlunds2.com/api/auth/saveProfileFirestore`, {
      method: 'POST',
      headers: {
